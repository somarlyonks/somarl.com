...
cover: /images/covers/Grid-Studio-Nahili-Poster.jpg
language: en
tags:
  - CSS
  - Workbook
...
import IllustrationFlexWrapItems from '@/components/post/illustrations/the-way-to-wrap-flex-items-is-grid'
